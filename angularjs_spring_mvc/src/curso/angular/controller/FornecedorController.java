...
public class FornecedorController extends DaoImplementacao<Fornecedor>
	...
	public ResponseEntity salvar(@RequestBody String jsonFornecedor)
		...
		//verifica se o fornecedor esta ativo ou nao
	...
	@ResponseBody
	public byte[] listar(@PathVariable("numeroPagina") String numeroPagina)
			throws Exception {
	...
	public @ResponseBody
	byte[] buscarFornecedor(@PathVariable("codFornecedor") String codFornecedor)
			throws Exception {
