...
public class ReportUtil implements Serializable{
	...
	private static final String FOLDER_RELATORIOS = "/relatorios"; //lugar do relatorio
	private static final String SUBREPORT_DIR = "SUBREPORT_DIR"; //variavel para o subreport
	private String SEPARATOR = File.separator;
	private String caminhoArquivoRelatorio = null;//caminho do relatorio
	private JRExporter tipoArquivoExportado = null;//tipo do da exportacao
	private String caminhoSubreport_Dir = "";//caminho do subreport-dir
	private File arquivoGerado = null;//aqruivo que vai ser gerado
	...
	public String geraRelatorio(List<?> listDataBeanColletionReport,
		...
		//caso nao encontre o caminho pega esse
