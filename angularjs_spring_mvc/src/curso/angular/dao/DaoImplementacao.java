...
public abstract class DaoImplementacao<T> implements DaoInterface<T> {
	...
	public void salvar(T objeto) throws Exception {
		sessionFactory.getCurrentSession().save(objeto);
		 sessionFactory.getCurrentSession().flush();/** flush executa o salvar e o hibernate faz a execusao do SQL */
	}
	...
	//metodo para listar os livros no carinho 
	@Override
	 ...
	 * @throws Exception
	 */ //metodo qu elista a quantidade de usuario e de livro na tela 
